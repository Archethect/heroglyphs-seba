...
contract DeployEthereum is Script {
    ...
    function run() external {
        ...
        address automator = 0x8FbBC54D49b23F5b397dfE62AD2Fb0E09Cbe9379;
        ...
        sebaPool = new SebaPool{ salt: versionSalt }(deployer, automator);
        ...
        eUsdUsdcBeefyYieldVault.revokeRole(eUsdUsdcBeefyYieldVault.YIELDMANAGER_ROLE(), deployer);
        ...
        ethToBoldRouter.revokeRole(ethToBoldRouter.YIELD_MANAGER_ROLE(), deployer);
        vm.stopBroadcast();
    }
}
